...
多くのMCPサーバーは、主に**Tool**を提供します。駅すぱあと API MCPサーバーも、経路探索などのToolを提供します。
...
駅すぱあと API MCPサーバーの場合、以下のような流れになります。
...
駅すぱあと API MCPサーバーは、**Streamable HTTP方式**で動作します。
...
**駅すぱあと API MCPサーバー**は、駅すぱあと APIをMCPクライアントから利用できるようにするMCPサーバーです。
...
このハンズオンでは、この駅すぱあと API MCPサーバーを実際に使いながら、MCPサーバーの仕組みを体験していきます。
